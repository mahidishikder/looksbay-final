...
export default function WorkStackedCard({
  ...
  return (
    ...
    >
      <div
        className={`relative w-full rounded-[28px] sm:rounded-[36px] bg-white border ${accent.border} shadow-[0_15px_40px_rgba(0,0,0,0.06),0_1px_3px_rgba(0,0,0,0.05)] hover:shadow-[0_25px_60px_rgba(124,58,237,0.14)] transition-all duration-500 overflow-hidden group`}
      >
