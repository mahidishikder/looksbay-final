    ...
    <section id="showcase" className="py-[100px] px-4 sm:px-8 lg:px-12 max-w-[1440px] mx-auto relative bg-white">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-6 mb-12">
        <div>
          ...
          <h2 className="text-3xl sm:text-5xl lg:text-6xl font-bold text-slate-950 tracking-tight leading-tight">
            Handcrafted websites that deliver measurable results.
          </h2>
        </div>

        <Link
          href="/portfolio"
          className="inline-flex items-center gap-2 text-sm font-semibold text-slate-900 hover:gap-3 transition-all shrink-0 group"
        >
          View All Works
