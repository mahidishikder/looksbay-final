      ...
      <div className="max-w-5xl mx-auto">
        ...
        {activeTab === "works" && (
          <div className="space-y-8 animate-fadeIn">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
              {[
                ...
                return (
                  <div
                    key={i}
                    className="glass-surface p-6 rounded-3xl bg-white border border-purple-100 shadow-sm text-center hover:shadow-md transition-shadow"
                  >
            ...
            <div className="glass-surface p-8 rounded-3xl bg-gradient-to-r from-[#2E1065] to-[#4C1D95] text-white flex flex-col md:flex-row items-center justify-between gap-6 shadow-xl">
              <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 animate-fadeIn">
            {[
              ...
              return (
                <div
                  key={i}
                  className="glass-surface p-8 rounded-3xl bg-white border border-purple-100 shadow-sm hover:shadow-md transition-all flex flex-col justify-between"
                >
                  <div>
          ...
          <div className="space-y-6 animate-fadeIn">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                <div
                  key={i}
                  className="glass-surface p-6 rounded-3xl bg-white border border-purple-100 shadow-sm text-center flex flex-col items-center"
                >
