...
const phases: Phase[] = [
  ...
  },
  {
    ...
    description:
      "Our senior Squarespace architects take over. Building natively on Squarespace 7.1 Fluid Engine with custom CSS flourishes and micro-animations, we craft lean, semantic layouts that load instantly, convert visitors, and can be easily managed by your team.",
    image:
      "https://images.unsplash.com/photo-1555066931-4365d14bab8c?w=1200&auto=format&fit=crop&q=80",
    deliverables: [
      "Squarespace 7.1 Fluid Engine Architecture",
      "Custom CSS Styling & Micro-Animations",
