...
export default function TemplatesPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-[#0F0F0F] font-sans">
      ...
      ══════════════════════════════════════════════════════════ */}
      <section className="bg-[#0F0F0F] text-white pt-28 pb-16 sm:pb-20 px-6 sm:px-10 lg:px-16 border-b border-white/10">
        <div className="max-w-[1640px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-3 hidden lg:block">
            <div className="relative aspect-[4/5] rounded-2xl overflow-hidden border border-white/15 shadow-2xl">
              ...
              <div className="absolute bottom-4 left-4 right-4 text-xs text-[#FFFFFF]/70">
                <span className="font-semibold text-[#FFFFFF]">Circle Platinum Partner</span>
                <p className="text-[11px] text-[#FFFFFF]/50">Award-winning Squarespace templates</p>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-6 text-center space-y-5">
            <p className="text-[11px] uppercase tracking-[0.25em] text-[#FC5001] font-semibold">
              Squarespace 7.1 Fluid Engine
            </p>
            <h1 className="text-3xl sm:text-5xl lg:text-[3.2rem] font-serif font-normal text-[#FFFFFF] tracking-tight leading-[1.12]">
              Premium Squarespace Templates for High-Growth Brands
            </h1>
            <p className="text-sm sm:text-base text-[#FFFFFF]/60 font-light max-w-xl mx-auto leading-relaxed">
            ...
            <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-4">
              <a
                href="#shop-catalog"
                className="px-8 py-3.5 bg-[#FC5001] hover:bg-[#FC5001]/90 text-[#FFFFFF] text-xs uppercase tracking-[0.16em] font-semibold transition-all shadow-md inline-flex items-center gap-2"
              >
            ...
            <div className="pt-4 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-xs text-[#FFFFFF]/60">
              <span className="flex items-center gap-1.5">
                <Check className="w-3.5 h-3.5 text-[#FC5001]" /> 6-Month Extended Free Trial
              </span>
              <span className="flex items-center gap-1.5">
                <Check className="w-3.5 h-3.5 text-[#FC5001]" /> 20% Off Annual Squarespace Plan
              </span>
              <span className="flex items-center gap-1.5">
                <Check className="w-3.5 h-3.5 text-[#FC5001]" /> Step-by-Step Video Setup
              </span>
            </div>
          </div>
          ...
          <div className="lg:col-span-3 hidden lg:block">
            <div className="relative aspect-[4/5] rounded-2xl overflow-hidden border border-[#FFFFFF]/15 shadow-2xl bg-[#0F0F0F]">
              <Image
      ...
      <section id="shop-catalog" className="py-16 sm:py-24 px-4 sm:px-8 lg:px-14 max-w-[1640px] mx-auto">
        ...
        <div className="text-center max-w-2xl mx-auto mb-8 sm:mb-10">
          <p className="text-[11px] uppercase tracking-[0.25em] text-[#FC5001] font-semibold mb-2">
            Explore By Industry
          </p>
          <h2 className="text-2xl sm:text-4xl font-black text-[#0F0F0F] tracking-tight">
        ...
        <div className="max-w-5xl mx-auto mb-14 sm:mb-16">
              ...
              return (
                <button
                  ...
                  className={`px-4 sm:px-5 py-2 sm:py-2.5 text-xs sm:text-[13px] tracking-wide transition-all duration-200 cursor-pointer ${
                    isSelected
                      ? "bg-[#FC5001] text-[#FFFFFF] font-semibold shadow-sm"
                      : "bg-[#FFFFFF] hover:bg-[#F5F5F5] text-[#0F0F0F]/70 border border-[#0F0F0F]/10 hover:border-[#FC5001]"
                  }`}
                >
                  {categoryName}
                </button>
          ...
          <div className="mt-8 flex items-center justify-between border-b border-[#0F0F0F]/10 pb-3 text-xs text-[#0F0F0F]">
            <p>
              Showing <span className="font-semibold text-[#0F0F0F]">{filteredTemplates.length}</span>{" "}
              {filteredTemplates.length === 1 ? "template" : "templates"} for{" "}
              <span className="font-semibold text-[#FC5001]">&quot;{selectedCategory}&quot;</span>
            </p>

            {selectedCategory !== "All templates" && (
              <button
                onClick={() => setSelectedCategory("All templates")}
                className="text-xs font-semibold text-[#FC5001] hover:underline"
              >
        ...
        {filteredTemplates.length === 0 ? (
          <div className="bg-[#FFFFFF] p-14 text-center border border-[#0F0F0F]/10 space-y-4 max-w-xl mx-auto my-12">
            <Sparkles className="w-8 h-8 text-[#0F0F0F]/40 mx-auto" />
            <h3 className="text-xl font-serif text-[#0F0F0F]">No templates found for this category</h3>
            <p className="text-xs text-[#0F0F0F]/50">
              Try selecting another category or click below to view all templates.
            </p>
            <button
              onClick={() => setSelectedCategory("All templates")}
              className="px-6 py-2.5 bg-[#0F0F0F] text-[#FFFFFF] text-xs uppercase tracking-wider font-semibold"
            >
              View All Templates
            </button>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-7 lg:gap-8">
            {filteredTemplates.map((tpl, idx) => (
              <Link
                ...
                className="group bg-white border border-[#0F0F0F]/10 hover:border-[#FC5001] transition-all duration-300 flex flex-col justify-between overflow-hidden shadow-xs hover:shadow-lg hover:shadow-orange-50 cursor-pointer"
              >
                {/* Large Mockup Card Display (Aspect Square, full size) */}
                <div className="relative aspect-square bg-[#F5F5F5] overflow-hidden">
                  {/* SALE Badge Top Right */}
                  {tpl.isSale && (
                    <span className="absolute top-3.5 right-3.5 z-20 bg-[#FC5001] text-white text-[10px] sm:text-[11px] font-bold tracking-widest px-2.5 py-0.5 sm:py-1 uppercase shadow-sm">
                      SALE
                    </span>
                  )}
                  ...
                  {tpl.bestseller && (
                    <span className="absolute top-3.5 left-3.5 z-20 bg-[#0F0F0F] text-white text-[9px] sm:text-[10px] font-bold tracking-wider px-2 py-0.5 uppercase shadow-sm">
                      Bestseller
                    </span>
                  )}
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1.5 mb-1.5">
                      {tpl.categories.slice(0, 2).map((cat) => (
                        <span
                          key={cat}
                          className="text-[10px] uppercase tracking-wider px-2 py-0.5 bg-orange-50 border border-[#FC5001]/20 text-[#FC5001] font-semibold"
                        >
                          {cat}
                        </span>
                      ))}
                    ...
                    <h3 className="text-xl sm:text-2xl font-black text-[#0F0F0F] group-hover:text-[#FC5001] transition-colors">
                      {tpl.name}
                    </h3>
                    <p className="text-xs text-[#0F0F0F] mt-1 line-clamp-2 leading-relaxed">
                      {tpl.tagline}
                    </p>
                  </div>

                  {/* Pricing & Action Links */}
                  <div className="pt-3.5 border-t border-[#0F0F0F]/10 flex items-center justify-between">
                    <div>
                      {tpl.salePrice ? (
                        <div className="flex items-baseline gap-1.5">
                          <span className="text-xs text-[#0F0F0F]/40 line-through font-medium">
                            ${tpl.price}
                          </span>
                          <span className="text-lg sm:text-xl font-black text-[#0F0F0F]">
                            ${tpl.salePrice}
                          </span>
                          <span className="text-[10px] text-[#0F0F0F]/40 uppercase font-medium">USD</span>
                        </div>
                      ) : (
                        <span className="text-lg sm:text-xl font-black text-[#0F0F0F]">
                          ${tpl.price} USD
                    ...
                    <span className="text-xs font-semibold uppercase tracking-wider text-[#0F0F0F] group-hover:text-[#FC5001] flex items-center gap-1 transition-colors group-hover:translate-x-0.5 duration-200">
                      <span>View</span>
      ...
      ══════════════════════════════════════════════════════════ */}
      <section className="bg-[#F5F5F5] py-20 sm:py-28 px-6 sm:px-10 lg:px-16 border-t border-[#0F0F0F]/10">
        <div className="max-w-[1640px] mx-auto space-y-14">
          ...
          <div className="text-center max-w-2xl mx-auto space-y-3">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-[#0F0F0F] tracking-tight leading-tight">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-10">
            {/* Review 1 */}
            <div className="bg-[#FFFFFF] p-7 sm:p-8 rounded-none border border-[#0F0F0F]/10 shadow-xs flex flex-col justify-between space-y-6">
              <div className="space-y-4">
                ...
                <p className="text-xs sm:text-sm text-[#0F0F0F]/60 leading-relaxed font-normal italic">
              ...
              <div className="flex items-center gap-3 pt-4 border-t border-[#0F0F0F]/10">
                <div className="w-10 h-10 rounded-full overflow-hidden relative bg-[#F5F5F5] shrink-0">
                  <Image
          ...
          <div className="pt-6 border-t border-[#0F0F0F]/10 flex flex-wrap items-center justify-around gap-6 text-center text-xs text-[#0F0F0F]">
            <div>
              <span className="text-xl sm:text-2xl font-black text-[#0F0F0F] block">4.9 / 5.0</span>
              <span className="text-[11px] uppercase tracking-wider text-[#0F0F0F]/50">Average Client Rating</span>
            </div>
            <div>
              <span className="text-xl sm:text-2xl font-serif font-bold text-[#0F0F0F] block">450+</span>
              <span className="text-[11px] uppercase tracking-wider text-[#0F0F0F]/50">Templates Launched</span>
            </div>
            <div>
              <span className="text-xl sm:text-2xl font-serif font-bold text-[#0F0F0F] block">100%</span>
              <span className="text-[11px] uppercase tracking-wider text-[#0F0F0F]/50">Squarespace 7.1 Fluid Engine</span>
            </div>
            <div>
              <span className="text-xl sm:text-2xl font-serif font-bold text-[#0F0F0F] block">6 Months</span>
              <span className="text-[11px] uppercase tracking-wider text-[#0F0F0F]/50">Extended Free Hosting Trial</span>
            </div>
          </div>
        </div>
      </section>
